...
vi.mock('../services/api', async () => {
  ...
  fetchLoansTotalAmount: () => Promise.resolve(f.loanAmountSummary),
  ...
  fetchStocksTotalValue: () => Promise.resolve(f.stockValueSummary),
...
const props: Record<string, Record<string, unknown>> = {
  ...
  TotalRentWidget: { portfolio: f.portfolio },
  TransactionLedgerWidget: { transactions: f.transactions },
  UnderpricedPropertiesWidget: { portfolio: f.portfolio },
